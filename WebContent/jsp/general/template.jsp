...
<head>
	...
	<title>Recommender administrator</title>
...
<!-- 		</div> -->
		...
		<div class="header-bottom">
			...
			<div class="nav2">				
				...
				<!-- Navigation item -->
				<ul>
					<li><a href="FCInit.do.admin">Admin</a></li>
				</ul>
				
				<ul>
					<li><a href="FCInit.do.spdCables">SPD-Cables</a></li>
				</ul>
				
				<ul>
					<li><a href="FCInit.do.gestionMantenimiento">Gestion de mantenimiento</a></li>
				</ul>
				
				<ul>
					<li><a href="FCInit.do.diagnoVisionRueda">DiagnoVision-Rueda</a></li>
				</ul>
				
				<ul>
					<li><a href="FCInit.do.diagnoDefectoRueda">DiagnoDefecto-Rueda</a></li>
				</ul>
				
				<ul>
					<li><a href="FCInit.do.conteoUsuariosMM">Conteo de usuario MM</a></li>
				</ul>
				
				<ul>
					<li><a href="FCInit.do.spdTrenes">SPD-trenes</a></li>
				</ul>

				<ul>
					<li><a href="FCInit.do.modivim">MODIVIM</a></li>
				</ul>
...
<%-- 				</c:if> --%>
		...
		<div class="main-content">
			...
			<c:if test="${not empty external}">
				<c:if test="${not empty url}">
					<iframe src="${url}" frameborder="0" width="100%" height="94%">
